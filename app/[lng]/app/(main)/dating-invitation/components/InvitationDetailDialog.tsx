...
const InvitationDetailDialog = ({
  ...
  return (
    <Modal size="lg" open={!!selectedScheduleID} onOpenChange={close}>
          ...
          <div className="flex justify-between gap-4 pb-5">
            <div className="flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Skeleton className="h-4 w-20 rounded-sm text-sm" />
                <Skeleton className="h-4 w-32 rounded-sm text-sm" />
              </div>
            </div>
      ...
      {selectedSchedule && (
        <>
          <h2 className="text-center text-lg font-semibold">Chi tiết</h2>
          ...
          <div className="w-full divide-y">
            <div className="flex justify-between gap-4 pb-5">
              <div className="flex items-center gap-2">
                ...
                />
                <div>
                  <p className="text-sm text-secondary-foreground">Người gửi</p>
                  <p>
