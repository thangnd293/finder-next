...
export const MobileUserCard = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "aspect-card w-full overflow-y-scroll rounded-lg bg-primary-50 md:rounded-3xl",
        )}
      >
        <div>
          <div className="relative flex aspect-[3/4] w-full flex-col justify-center">
            ...
            <div className="absolute bottom-1.5 left-2 text-white">
              <p className="text-xl font-extrabold drop-shadow">
                {name}, {age}
              </p>
              {school && (
          ...
          <div className="space-y-3 px-4 py-5">
            ...
            <div className="flex w-full items-center justify-center gap-6 pt-10">
              ...
              <ActionIcon className="h-14 w-14 -translate-y-1/2 rounded-full bg-primary text-yellow-100">
                <FaStar size={20} />
              </ActionIcon>
