...
export default function Modal({
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange} {...others}>
      <Dialog.Portal>
        {withOverlay && (
          <Dialog.Overlay className="fixed inset-0 z-50 bg-modal-overplay data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
        )}
